...
| B2B Sample - Inhouse workflow (tests/e2e/b2b-sample-inhouse-workflow, TC-B2B-SMP-01…05) | **BLOCKED** — app bug in Worker Issue/Receipt for the sample flow (QA lead, 31-08-2026); all steps fixme until dev fixes it |
